 ...
 * <p>
 * Entity から Domain への変換時は ValueObject のラッピングを実施し、
 * Domain から Entity への変換時は ValueObject から値を抽出する。
 * </p>
 */
public class TodoMapper {
     ...
     * <p>
     * Entity のプリミティブ値を ValueObject でラップし、
     * ドメインモデルとして再構成する。
     * </p>
     *
     ...
     * <p>
     * Domain の ValueObject から値を抽出し、
     * Entity のプリミティブフィールドに設定する。
     * </p>
     *
